...
<body>
	...
	<div class="navbar">
		...
		<li><a href="{{URL::to('/profile')}}" onclick="return confirm('Are you want to see profile')"><i class="halflings-icon user"></i> Profile</a></li>
		<li><a href="{{URL::to('/logout')}}" onclick="return confirm('Are you want to logout')"><i class="halflings-icon off"></i> Logout</a></li>
							</ul>
						</li>
						<!-- end: User Dropdown -->
					</ul>
...
<li><a href="{{URL::to('/manage_contact')}}"><i class="icon-list-alt"></i><span class="hidden-tablet">Manage contact</span></a></li>
