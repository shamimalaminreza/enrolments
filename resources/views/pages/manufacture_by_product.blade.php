...
<h2 class="title text-center">Features Items</h2>
                          ...
                          foreach ($all_manufacture_product as  $v_manufacture_product) {?>
                        <div class="col-sm-4">

                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
    <img src="{{URL::to($v_manufacture_product->product_image)}}" alt="" style="height: 150px; width: 150px" />
                                        <h2>{{$v_manufacture_product->product_price}} TK</h2>
                                        <p>{{$v_manufacture_product->product_name}}</p>
                     <a href="{{URL::to('/view_product/'.$v_manufacture_product->product_id)}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                    </div>
                        ...
                        <a href="{{URL::to('/view_product/'.$v_manufacture_product->product_id)}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                ...
                                <div class="choose">
                                    <ul class="nav nav-pills nav-justified">
                                        ...
                                        {{$v_manufacture_product->manufacture_name}}
                                       </a></li>
