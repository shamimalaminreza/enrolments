                    ...
                    <div class="category-tab"><!--category-tab-->
                        <div class="col-sm-12">
                            ...
                            <ul class="nav nav-tabs">
                                  <?php
                $Category=DB::table('tbl_category')->where('publication_status',1)->limit(9)->get();

                          foreach ($Category as  $v_category) {?>
                         

     <li><a href="{{URL::to('/product_by_category/'.$v_category->category_id)}}" data-toggle="tab">{{$v_category->category_name}}</a></li>
                            <?php }?>
                            </ul>
