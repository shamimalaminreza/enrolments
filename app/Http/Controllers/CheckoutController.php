...
Session::put('mssas','Successfully registrate');
...
}elseif ($payment_method=='Hand cash') {
//f Cartdestory
  Cart::destroy();
  return view('pages.Hand_cash');

  }elseif ($payment_method=='Devit Cart') {
     echo "Cart";
